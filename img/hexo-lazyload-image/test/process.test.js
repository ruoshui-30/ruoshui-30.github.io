...
it('should use default image if no specify custom image', () => {
  ...
  const htmlContent = `<img src="/img/lazyload/1.jpg" data-original="abc.png" />`;
...
it('should handle multi cases for `<img />` tag for replace', () => {
  const testCases = [
    {
      actual: `<img src="/img/lazyload/1.jpg" data-original="abc.png" />`,
      expect: `<img src="${myLoadingImg}" data-original="abc.png" />`
    },
    {
      actual: `<img src="/img/lazyload/1.jpg" data-original="abc.png" /><img src="/img/lazyload/1.jpg" data-original="def.png" />`,
      expect: `<img src="${myLoadingImg}" data-original="abc.png" /><img src="${myLoadingImg}" data-original="def.png" />`
    },
    {
      actual: `<img style="width:100px" src="/img/lazyload/1.jpg" data-original="abc.png"></img>`,
      expect: `<img style="width:100px" src="${myLoadingImg}" data-original="abc.png"></img>`
    },
    {
      actual: `<img class="abc" src="/img/lazyload/1.jpg" data-original="abc.png"></img>`,
